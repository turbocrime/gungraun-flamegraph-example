...
#[inline(never)] fn a01_l(n: u64) -> u64 { work(n * 10) }
#[inline(never)] fn a01_r(n: u64) -> u64 { work(n * 1000) }
#[inline(never)] fn b01_l(n: u64) -> u64 { work(n * 1012) }
#[inline(never)] fn b01_r(n: u64) -> u64 { work(n * 22) }
...
#[inline(never)] fn a02_l(n: u64) -> u64 { work(n * 11) }
...
#[inline(never)] fn a03_l(n: u64) -> u64 { work(n * 12) }
...
#[inline(never)] fn a04_l(n: u64) -> u64 { work(n * 13) }
...
#[inline(never)] fn a05_l(n: u64) -> u64 { work(n * 14) }
...
#[inline(never)] fn a06_l(n: u64) -> u64 { work(n * 15) }
...
#[inline(never)] fn a07_l(n: u64) -> u64 { work(n * 16) }
...
#[inline(never)] fn a08_l(n: u64) -> u64 { work(n * 17) }
...
#[inline(never)] fn a09_l(n: u64) -> u64 { work(n * 18) }
...
#[inline(never)] fn a10_l(n: u64) -> u64 { work(n * 19) }
...
#[inline(never)] fn a11_l(n: u64) -> u64 { work(n * 20) }
...
#[inline(never)] fn a12_l(n: u64) -> u64 { work(n * 21) }
#[inline(never)] fn a12_c(n: u64) -> u64 { work(n * 100) }
#[inline(never)] fn a12_r(n: u64) -> u64 { work(n * 1011) }
...
#[inline(never)] fn b02_l(n: u64) -> u64 { work(n * 1013) }
...
#[inline(never)] fn b03_l(n: u64) -> u64 { work(n * 1014) }
...
#[inline(never)] fn b04_l(n: u64) -> u64 { work(n * 1015) }
...
#[inline(never)] fn b05_l(n: u64) -> u64 { work(n * 1016) }
...
#[inline(never)] fn b06_l(n: u64) -> u64 { work(n * 1017) }
...
#[inline(never)] fn b07_l(n: u64) -> u64 { work(n * 1018) }
...
#[inline(never)] fn b08_l(n: u64) -> u64 { work(n * 1019) }
...
#[inline(never)] fn b09_l(n: u64) -> u64 { work(n * 1020) }
...
#[inline(never)] fn b10_l(n: u64) -> u64 { work(n * 1021) }
...
#[inline(never)] fn b11_l(n: u64) -> u64 { work(n * 1022) }
#[inline(never)] fn b11_c(n: u64) -> u64 { work(n * 101) }
#[inline(never)] fn b11_r(n: u64) -> u64 { work(n * 32) }
